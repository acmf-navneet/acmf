...
public class JdlRequest {
    ...
    /**
     * Optional full JDL content (application + entities + relationships).
     * When set, the generator will use "jhipster jdl" to create the app with domain entities
     * instead of app-only generation from .yo-rc.json.
     */
