...
const StepProgress1 = () => {
  return (
    <ol className="flex items-center w-full justify-center relative">
      ...
      <li className="flex-1 flex items-center after:content-[''] after:flex-1 after:h-2 after:bg-gray-100 dark:after:bg-blue-700 relative group">
      ...
      <li className="flex-1 flex items-center w-full relative group">
        ...
        <div
          className="absolute z-10 hidden group-hover:flex items-center justify-center px-3 py-2 text-sm font-medium text-white bg-[#004C7B] rounded-lg shadow-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 dark:bg-gray-700 bottom-full mb-2 left-1/2 transform -translate-x-1/2"
          role="tooltip"
        >
          Project Created
          <div className="tooltip-arrow" data-popper-arrow></div>
